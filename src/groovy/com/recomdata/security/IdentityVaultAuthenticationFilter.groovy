...
class IdentityVaultAuthenticationFilter extends GenericFilterBean	{
	...
	void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
		...
		if (requiresAuthentication(request, response)) {
			...
			def userPass = ConfigurationHolder.config.com.recomdata.searchtool.identityVaultCredentials
...
*/
			...
			String userLanding = ConfigurationHolder.config.grails.plugin.springsecurity.successHandler.defaultTargetUrl
